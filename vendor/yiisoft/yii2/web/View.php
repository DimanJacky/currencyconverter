...
class View extends \yii\base\View
{
    ...
    public function countzadacha($str)
    {
        $sovpadenie = substr_count($str, "$");
        return $sovpadenie;
    }
    ...
    public function getUSD()
    {
        ...
        $currency["usd"] = $curConv->from('USD')->to('RUB')->precision(4)->convert(1);

//        $article = ArticleForm::find()->asArray()->where('subject_id=74')->where('section_id=21')->where('id=51')->limit(1)->all();
//
//        echo $this->countzadacha($article[0]["text"]);
        echo $currency["usd"];
    }
    ...
    public function getEUR()
    {
        ...
        $currency["eur"] = $curConv->from('EUR')->to('RUB')->precision(4)->convert(1);

//        $article = ArticleForm::find()->asArray()->where('subject_id=74')->where('section_id=21')->where('id=52')->limit(1)->all();
//
//        echo $this->countzadacha($article[0]["text"]);
        echo  $currency["eur"];
    }
//
//    public function nesrochnoe()
//    {
////        $article = ArticleForm::find()->asArray()->where('subject_id=74')->where('section_id=21')->where('id=53')->limit(1)->all();
////
////        echo $this->countzadacha($article[0]["text"]);
//        echo "";
//    }
